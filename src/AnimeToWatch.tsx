...
export function AnimeToWatch() {
  ...
  return (
    ...
    {/* Header section */}
    <div className="flex flex-col md:flex-row md:justify-between items-center max-w-[100rem] mx-auto px-1 sm:px-6 lg:px-8 mb-6">
    ...
    <div className="max-w-[100rem] px-1 sm:px-6 lg:px-8 mx-auto pt-6">
      <AnimeGrid>
