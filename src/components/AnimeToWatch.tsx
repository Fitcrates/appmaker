            ...
            <div className="flex flex-col md:flex-row gap-4 w-full md:w-auto">
              ...
              <div className="relative w-full md:w-auto" ref={statusDropdownRef}>
                ...
                {isStatusDropdownOpen && (
                  <div className="absolute left-0 md:left-auto right-0 top-full mt-2 w-full md:w-64 bg-white border rounded-lg shadow-lg z-50">
              ...
              <div className="relative w-full md:w-auto" ref={genreDropdownRef}>
                <button
