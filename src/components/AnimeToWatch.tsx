...
export function AnimeToWatch() {
  ...
  return (
    <div className="container mx-auto py-12 max-w-[100rem] space-y-6  px-0 sm:px-6 lg:px-8 backgroundMain">
      <div className="flex max-w-[100rem] px-4 sm:px-6 lg:px-8 justify-between items-center mx-auto">
  <h2 className="text-3xl text-[#4ef1d6] drop-shadow-[0_0_8px_#4ef1d6] mt-24 mb-12 tilt-neon">
    <span className="bg-clip-text text-[#4ef1d6] drop-shadow-[0_0_8px_#4ef1d6]">
      My Watchlist
    </span>
  </h2>
  
  <div className="relative mt-24 mb-12 flex items-center">
    ...
    >
      ...
      <div className="flex space-x-6 max-w-[100rem]  px-4 sm:px-6 lg:px-8 justify-left items-center mx-auto ">
        <SearchBar
