  ...
  <div className="max-w-[100rem] px-4 sm:px-6 lg:px-8 mx-auto mb-6 mt-12">
    ...
    <div className="flex flex-col sm:flex-row justify-center sm:justify-between items-center w-full gap-8">
      ...
      <div className="w-[300px]">
        <div className="ring-1 ring-white/40 rounded-lg shadow-sm">
          <div className="text-xs pt-1 font-medium text-center text-white">
            Rating Range: <span className="notranslate">{ratingRange[0]} - {ratingRange[1]}</span>
          </div>
      ...
      <div className="relative flex items-center ">
        <span className="bg-clip-text text-[#ff13f0] drop-shadow-[0_0_8px_#ff13f0] tilt-neon2 px-4 py-2">
          Total Rated: <span className="notranslate">{totalItems}</span>
        </span>
        <svg 
          xmlns="http://www.w3.org/2000/svg" 
          xmlnsXlink="http://www.w3.org/1999/xlink" 
          viewBox="0 0 80 80"
          className="absolute -right-2 w-12 h-12 md:w-14 md:h-14 stroke-[#ff13f0] drop-shadow-[4_0_8px_#ff13f0] stroke-2 fill-none"
        >
          <defs>
                ...
                <LazyLoad>
                  <div className="relative rounded-t-xl overflow-t-hidden aspect-[3/4] max-h-[18rem]">
                    ...
                    <div className="absolute top-3 left-3 bg-black/70 backdrop-blur-md rounded-full px-3 py-1.5 flex space-x-2 items-center text-white">
                      ...
                      <span className="notranslate">{anime.rating.toFixed(1)}</span>
                    </div>
                  </div>
                </LazyLoad>
