      ...
      {days.map((day) => (
        <button
          ...
          className={`px-4 py-2 mt-2 rounded-lg whitespace-nowrap transition-colors ${
            activeDay === day.id
              ? 'ring-2 ring-[#4ef1d6] shadow-lg shadow-[#4ef1d6]/50 inset-shadowGreen text-white'
              : 'bg-black/10 backdrop-blur-sm ring-1 ring-white/30 text-white hover:bg-[#4ef1d6]'
          }`}
        >
          {day.label}
        </button>
