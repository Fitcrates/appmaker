...
function ErrorBoundaryWrapper(props: Props) {
  ...
  try {
    ...
    console.warn('Auth context not available in ErrorBoundary');
  }
...
class ErrorBoundaryClass extends Component<Props & {
  ...
  private getErrorMessage(): string {
    ...
    if (location.pathname.startsWith('/user/') && this.props.auth && !this.props.auth.user) {
  ...
  private handleRetry = async () => {
    ...
    if (location.pathname.startsWith('/user/') && auth) {
