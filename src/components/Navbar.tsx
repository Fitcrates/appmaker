...
export default function Navbar() {
  ...
  return ( 
    <>
        ...
        <div className="max-w-[100rem] space-y-6 mx-auto justify-center px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16 min-h-[64px]">
            <div className="flex items-center">
              {/* Desktop navigation */}
              <div className="flex-shrink-0 flex items-center mr-8 gap-12">
                <Link to="/" className="bg-clip-text text-[#ffe921] drop-shadow-[0_0_8px_#ffe921] leading-tight notranslate tilt-neonCustom " >
                  AnimeVersum
                </Link>
              </div>
              ...
              <Link
                ...
                className="text-white hover:text-[#4ef1d6] hover:drop-shadow-[0_0_8px_#ffe921] p-2 rounded-lg flex  text-sm items-center"
              >
                <Telescope className="h-5 w-5" />
                <span className="hidden md:inline ml-3">Explore anime</span>
              </Link>
              <button
                onClick={() => {
                ...
                className="text-white hover:text-[#4ef1d6] hover:drop-shadow-[0_0_8px_#ffe921] p-2 rounded-lg flex items-center text-sm  ml-6" 
                aria-label="Search"
              >
                <Search className="h-5 w-5" />
                <span className="hidden md:inline ml-3">Quick search</span>
              </button>
              <div className="hidden lg:flex lg:items-center lg:space-x-6">
                ...
                <Link
                  to="/forum"
                  className="text-white hover:bg-clip-text hover:text-[#4ef1d6] hover:drop-shadow-[0_0_8px_#4ef1d6] px-3 py-2 rounded-md text-sm ml-6 font-medium"
                >
                  Forum
                </Link>
                <Link
                  ...
                  <div className="relative group z-50">
                    ...
                    <div className="absolute right-0 ring-1 ring-white/40 w-48 backgroundMain rounded-md shadow-lg py-1 invisible group-hover:visible opacity-0 group-hover:opacity-100 transition-all duration-150 ease-in-out">
                      ...
                      <button
                        ...
                        className="block px-4 py-2 text-sm text-white hover:bg-clip-text hover:text-[#bd4c4c] hover:drop-shadow-[0_0_8px_#bd4c4c]"
                      >
                        Sign Out
                      </button>
                    </div>
      ...
      {/* Move modals outside the nav to ensure they're not affected by nav positioning */}
