        ...
        <>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4">
            {displayedEpisodes.map((episode) => (
              ...
              >
                <h3 className="font-medium">Episode {episode.mal_id}: {episode.title}</h3>
                {episode.title_japanese && (
                  <p className="text-sm text-gray-600">{episode.title_japanese}</p>
                )}
                {episode.aired && (
      ...
      {selectedEpisode && (
        ...
        >
          <div className="p-6 max-w-2xl w-full">
            <h2 className="text-xl font-bold mb-4">{selectedEpisode.title}</h2>
            {selectedEpisode.title_japanese && (
              <p className="text-gray-600 mb-4">{selectedEpisode.title_japanese}</p>
            )}
            ...
            <p className="whitespace-pre-wrap">{selectedEpisode.synopsis}</p>
