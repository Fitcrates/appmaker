    ...
    <div className="flex justify-between items-center w-full">
      ...
      <div className="relative flex items-center">
        ...
        >
          ...
          <div className="max-w-[100rem] space-y-6 mx-auto px-1 sm:px-6 lg:px-8 mt-12">
                    ...
                    <div className="relative rounded-t-xl overflow-t-hidden aspect-[2/3] h-[15rem] sm:h-[14rem] md:h-[16rem] lg:h-[17rem] xl:h-[18rem]">
                      ...
                      {anime.score > 0 && (
                        <div className="absolute top-3 left-2 bg-black/70 backdrop-blur-sm rounded-full px-3 py-1.5 flex items-center">
                          ...
                          <span className="ml-1.5 text-sm font-mono text-white notranslate">{anime.score.toFixed(1)}</span>
                        </div>
                      )}
                    </div>
