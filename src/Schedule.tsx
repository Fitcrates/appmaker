...
export function Schedule() {
  ...
  return (
    <div id="schedule" className="max-w-[100rem] space-y-6 mx-auto px-1 sm:px-6 lg:px-8">
            ...
            {schedule.map((anime, index) => (
              <div key={`${activeDay}-${anime.mal_id}-${index}`} className="relative group">
                <LazyLoad>
                  ...
                  >
                    {/* Image Container */}
                    <div className="relative rounded-t-xl overflow-t-hidden aspect-[3/4] h-[15rem] sm:max-h-[20rem]">
                      <img
